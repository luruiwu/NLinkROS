...
Serial::SerialImpl::SerialImpl(const string &port, unsigned long baudrate,
    ...
    : port_(port.begin(), port.end()), fd_(INVALID_HANDLE_VALUE),
      is_open_(false), baudrate_(baudrate), parity_(parity),
...
void Serial::SerialImpl::open() {
  ...
  fd_ = CreateFileW(lp_port, GENERIC_READ | GENERIC_WRITE, 0, 0, OPEN_EXISTING,
